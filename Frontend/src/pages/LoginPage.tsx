...
import { getContactWhatsAppUrl, login } from "../lib/auth";
...
export default function LoginPage({ onSuccess, onSignup, contactPhone }: LoginPageProps) {
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4">
              ...
              <div className="text-center text-[11px] text-zinc-200/80 pt-1 leading-relaxed">
                ...
                <p>
                  Precisa de ajuda?{" "}
                  <a
                    href={getContactWhatsAppUrl(contactPhone)}
                    target="_blank"
